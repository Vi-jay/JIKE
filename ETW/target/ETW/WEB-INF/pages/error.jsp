...
<!DOCTYPE html>
<!-- saved from url=(0036)http://yuweining.cn/t/Html5/404html/ -->
<html>
<head>
    ...
    <meta name="description" content="mrjoel&#39;s website">
    <title>唉~又出错了。</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/base/error/love.css">
    <link rel="shortcut icon" type="image/x-icon" href="http://yuweining.cn/favicon.ico">
    <style>
        html,body{
            overflow-y: scroll;
            overflow-x: hidden;
...
<div class="container">
    ...
    <div class="content">
        ...
        <canvas id="universe" width="1280" height="636"></canvas>
<c:if test="${errorCode != null}">

<div id="footerContent"><a href="#" style="font-size: 32px">—— ${errorCode} ——</a></div>
</c:if>
        <div id="footer">
            <svg id="scene" x="0px" y="0px" width="1600px" height="315px">
                ...
                <path id="stone2"
                      d="M750.5,243.1709c3.25,0,2.5-3.707-1.75-4.2285s-5,3.7285-3,4.2285S750.5,243.1709,750.5,243.1709z"></path>
                ...
                <path id="stone4"
                      d="M697,248.9355c2.0142-0.2021,2.1665-2.0156,1-2.1816s-9.1543,1.8398-5.9937,2.6699S697,248.9355,697,248.9355z"></path>
                <g id="greens" transform="translate(850, 180)">
                    <g transform="skewX(9.48204)">
...
<div style="z-index: 1000;position: absolute;left: 20px;top: 0">
    <H2 style="color: deepskyblue">error :<h3
            style="color: #d2d2d2;margin-left: 5px"><%=exception == null ? request.getAttribute("errorCode") : exception%>
    </h3></H2>
    <c:if test="${errorCode == null}">
    <H2 style="color: deepskyblue">message :</H2>
    </c:if>
    <p style="color: #c9c9c9;width: 500px;margin-left: 5px">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/base/error/love.js"></script>
