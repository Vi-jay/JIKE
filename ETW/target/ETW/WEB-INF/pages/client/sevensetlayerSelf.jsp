    ...
    <div id="etw_topmenu">
        <div class="container">
            <ul class="etw_submenu">
                ...
                <li><a href="${path}/client/page/sevensetlayerSelf" class="active">公司介绍</a></li>
...
<div id="app" class="article-content-wrapper" v-loading="loading">
    <iframe src="${path}/editor/searchPage/2" frameborder="0" id="articleContent"
            style="width: 100%;overflow:hidden;padding: 0 16%"></iframe>
</div>
