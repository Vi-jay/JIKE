...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            setTimeout(function () {\n");
      out.write("                document.querySelector(\"html\").style.display = \"\";\n");
      out.write("            })\n");
      out.write("        });\n");
      out.write("\n");
      out.write("    </script>\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/ueditor/ueditor.parse.js\"></script>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      ...
      out.write("         @mouseleave=\"isCollapse = true\">\n");
      ...
      out.write("                    <template slot=\"title\">入口1</template>\n");
      out.write("                    <el-menu-item index=\"1-1\">模块1</el-menu-item>\n");
      out.write("                    <el-menu-item index=\"1-2\">模块2</el-menu-item>\n");
      out.write("                </el-menu-item-group>\n");
      out.write("\n");
      out.write("                <el-menu-item-group>\n");
      out.write("                    <template slot=\"title\">入口2</template>\n");
      out.write("                    <el-menu-item index=\"1-5\">模块1</el-menu-item>\n");
      out.write("                    <el-menu-item index=\"1-6\">模块2</el-menu-item>\n");
      out.write("                </el-menu-item-group>\n");
      out.write("                <el-menu-item-group title=\"入口3\">\n");
      out.write("                    <el-menu-item index=\"1-9\">模块1</el-menu-item>\n");
      out.write("                </el-menu-item-group>\n");
      out.write("                <el-submenu index=\"1-9\">\n");
      out.write("                    <template slot=\"title\">子模块</template>\n");
      out.write("                    <el-menu-item index=\"1-9-1\">子模块1</el-menu-item>\n");
      out.write("                </el-submenu>\n");
      out.write("            </el-submenu>\n");
      out.write("            <el-menu-item index=\"2\">\n");
      out.write("                <i class=\"el-icon-menu\"></i>\n");
      out.write("                <span slot=\"title\">资源库</span>\n");
      out.write("            </el-menu-item>\n");
      out.write("            <el-menu-item index=\"3\" disabled>\n");
      out.write("                <i class=\"el-icon-document\"></i>\n");
      out.write("                <span slot=\"title\">文章管理</span>\n");
      out.write("            </el-menu-item>\n");
      out.write("            <el-menu-item index=\"4\">\n");
      ...
      out.write("        </el-menu>\n");
      out.write("    </div>\n");
      out.write("<template v-if=\"!editableTabs.length\" >\n");
      out.write("    <iframe  src=\"http://www.feihuwangluo.com/\" frameborder=\"0\" style=\"width: calc(100% - 60px);height:calc(100% - 60px);margin-top: 60px;margin-left: 60px \"></iframe>\n");
      out.write("</template>\n");
      out.write("    <template v-else>\n");
      out.write("    ");
      out.write("\n");
      out.write("    <article style=\"width: calc(100% - 60px);height:calc(100% - 60px);margin-top: 60px;margin-left: 60px \">\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${path}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/resource/js/manager/main.js\"></script>\n");
      out.write("</body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
