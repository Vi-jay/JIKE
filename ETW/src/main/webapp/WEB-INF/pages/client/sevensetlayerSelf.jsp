...
<header>
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="https://www.即客service.com/"><img src="${path}/resource/css/index_files/etw-logo-white.png" alt=""></a>
                        </div>
    ...
    <div id="etw_topmenu">
        <div class="container">
            <ul class="etw_submenu"> <li class="mainsub">关于即客</li><li><a href="/sevensetlayer_self.htm" class="active">公司介绍</a></li><li><a href="/thsetlayer_self.htm">选择即客的理由</a></li><li><a  href="/talking.html">即客视角</a></li></ul>
        </div>
    </div>
</header>
...
<div class="content-wrapper" style="min-height: 60%;width: 100%;padding: 120px 0 0 0">
    <iframe src="${path}/editor/searchPage/2" frameborder="0" id="articleContent" style="width: 100%;overflow:hidden;padding: 0 16%"></iframe>
</div>
