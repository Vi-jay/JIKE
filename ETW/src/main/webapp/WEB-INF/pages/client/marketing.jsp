...
<header>
    ...
    <div id="etw_topmenu">
        <div class="container">
            <ul class="etw_submenu"> <li class="mainsub">即客产品介绍</li><li><a href="/sevensetlayer_self.htm" >即客数据管理</a></li><li><a href="/thsetlayer_self.htm" class="active">即客产品介绍</a></li></ul>
        </div>
    </div>
</header>
...
<div class="content-wrapper" style="min-height: 60%;width: 100%;padding: 120px 0 0 0">
    <iframe src="${path}/editor/searchPage/5" frameborder="0" id="articleContent" style="width: 100%;overflow:hidden;transform: scale(0.9)"></iframe>
</div>
