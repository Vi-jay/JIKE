...
<header>
    ...
    <div id="etw_topmenu">
        <div class="container">
            <ul class="etw_submenu"> <li class="mainsub">关于即客</li><li><a href="/sevensetlayer_self.htm" >公司介绍</a></li><li><a href="/thsetlayer_self.htm" class="active">选择即客的理由</a></li><li><a  href="/talking.html">即客视角</a></li></ul>
        </div>
    </div>
</header>
...
<div class="content-wrapper" style="min-height: 60%;width: 100%;padding: 120px 0 0 0">
    <iframe src="${path}/editor/searchPage/3" frameborder="0" id="articleContent" style="width: 100%;overflow:hidden;padding: 0 16%"></iframe>
</div>
